...
namespace ChobiAssets.PTM
{
	...
	public class Cannon_Fire_CS : MonoBehaviour
	{
		...
		void AI_Set_Can_Aim ()
		{
			// Make sure that the target is within eyeaim.
		...
		{
			if (aiScript.Target_Distance < aiScript.OpenFire_Distance && aiScript.Can_Aim) { // Target is within OpenFire_Distance and eyeaim.
			...
			} else { // Target is out of OpenFire_Distance or eyeaim.
				aimingCount = 0.0f;
				waitingCount = 0.0f;
			}
		}
